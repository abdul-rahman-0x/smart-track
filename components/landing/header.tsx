...
export default async function Header() {
  ...
  return (
    <header className="fixed left-1/2 top-4 z-50 flex h-14 w-[calc(100%-1.5rem)] max-w-175 -translate-x-1/2 items-center justify-between rounded-full border border-border/50 bg-background/80 px-3 shadow-sm backdrop-blur-xl transition-all md:top-6 md:h-15 md:w-[calc(100%-2rem)]">
      <Link
        href="/#home"
